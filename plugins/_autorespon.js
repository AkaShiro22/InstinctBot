...
└────
https://github.com/
`.trim(), '© InstinctBot', 'PEMILIK BOT', ',owner', { contextInfo: { mentionedJid: [global.owner[0] + '@s.whatsapp.net'] } })
    }
    ...
    if (new Date() * 1 - setting.status > 1000) {
        ...
        await this.setStatus(`Aktif selama ${uptime} | Mode: ${global.opts['self'] ? 'Private' : 'Publik'} | InstinctBot oleh InstinctBot`).catch(_ => _)
