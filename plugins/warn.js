  ...
  const time = async (ms) => {
    return new Promise(resolve => setTimeout(resolve, ms));
        ...
        if (warn < 2) {
            ...
            m.reply('Kamu telah diperingatkan oleh admin, dan sekarang kamu punya ' + (warn + 1) + ' warn . INGAT !!! Jika kamu mendapatkan warn 3 kali kamu akan otomatis ditendang dari Grup', ban)
        } else if (warn == 2) {
